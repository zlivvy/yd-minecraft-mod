...
public class MyEntitySpider extends EntityTameable
{
     ...
     */
    public MyEntitySpider spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        MyEntitySpider entitywolf = new MyEntitySpider(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof MyEntitySpider))
        {
            return false;
        }
        else
        {
            MyEntitySpider entitywolf = (MyEntitySpider)par1EntityAnimal;
    ...
    public boolean func_142018_a(EntityLivingBase par1EntityLivingBase, EntityLivingBase par2EntityLivingBase)
    {
        ...
        {
            if (par1EntityLivingBase instanceof MyEntitySpider)
            {
                MyEntitySpider entitywolf = (MyEntitySpider)par1EntityLivingBase;
